...
export default class MyDocument extends Document<{ testAgent?: boolean }> {
  render() {
    const isTestAgent = !!this.props.testAgent;
    return (
      <Html>
        <Head>
          {!isTestAgent && (
            <>
              <script
                ...
                charSet="UTF-8"
                src="//cdn.cookie-script.com/s/a9ace36280c260ea11ce808908fa18fa.js"
              ></script>
              {isProduction && (
                <>
                  <script
              ...
              <>
                <script
                  dangerouslySetInnerHTML={{
                    ...
                    __html: `
                  var _rollbarConfig = {
                          accessToken: "96352a37df7c4b4e811cb677408213f6",
...
MyDocument.getInitialProps = async (ctx) => {
  ...
  return {
    ...
    testAgent: ctx.query["test-agent"] === "true",
  };
};
