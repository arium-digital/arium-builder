...
let hackyMobileSafariTestValue: boolean | null = null;
...
export function hackyMobileSafariTest(): boolean {
  if (hackyMobileSafariTestValue === null) {
    hackyMobileSafariTestValue =
      /\b(Macintosh|iPad|iPhone)\b/i.test(navigator.userAgent) &&
      detectTouchScreen();
  }
