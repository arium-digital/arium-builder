import { useEditingElementState } from "components/InSpaceEditor/ElementTransform/WithTransformControls";
import { EditorStatus, HasEditorState } from "components/InSpaceEditor/types";
