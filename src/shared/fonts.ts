const fonts = {
  Roboto:
    "https://fonts.gstatic.com/s/roboto/v18/KFOmCnqEu92Fr1Mu4mxM.woff?subsets=greek,greek-ext,latin,latin-ext",
  "Noto Sans":
  ...
  "Cutive Mono":
    "https://fonts.gstatic.com/s/cutivemono/v6/m8JWjfRfY7WVjVi2E-K9H6RCTmg.woff",
  Gabriela:
  ...
  "Space Grotesque":
    "https://fonts.gstatic.com/s/spacegrotesk/v6/V8mQoQDjQSkFtoMM3T6r8E7mF71Q-gOoraIAEj7oUXskPMZBSSJLm2E.woff",
  Syncopate:
