...
const Portal = dynamic(() => import("Space/Elements/Portal"));
const ImageDisplay = dynamic(() => import("Space/Elements/ImageDisplay"));
const TextDisplay = dynamic(() => import("../TextDisplay"));
const ReflectorSurface = dynamic(
  () => import("Space/Elements/ReflectorSurface")
);
const Water = dynamic(() => import("Space/Elements/Water"));
