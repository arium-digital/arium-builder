...
export interface OpenSeaAssetBundle {
  ...
  permalink: string;
  sellOrders: Order[] | null;
  assetContract?: OpenSeaAssetContract | null;
  description?: string;
  externalLink?: string;
}
...
export declare type ExchangeMetadata =
...
export interface Order extends UnsignedOrder /*, Partial<ECSignature>*/ {
  ...
  paymentTokenContract?: OpenSeaFungibleToken | null;
  feeRecipientAccount?: OpenSeaAccount;
  cancelledOrFinalized?: boolean;
  markedInvalid?: boolean;
  asset?: OpenSeaAsset | null;
  assetBundle?: OpenSeaAssetBundle | null;
}
/**
...
export declare type PartialReadonlyContractAbi = Array<
  Readonly<PartialAbiDefinition>
>;
...
export type OpenSeaToken = OpenSeaAsset;
